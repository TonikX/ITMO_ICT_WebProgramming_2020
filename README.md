...
Контейниризация и оркатсрация приложений сердствами docker и docker-compose. Задание и мануалы доступны [тут](https://github.com/vngrv/docker-tutorial).
Полученную программу залить в папку этого репозитория **sutdents/группа/practical_works/фамилия_имя/docker**. Инструкция о загрузке работы ниже. Не забывайте о файле гитигнор. **Срок сдачи: день экзамена.**
