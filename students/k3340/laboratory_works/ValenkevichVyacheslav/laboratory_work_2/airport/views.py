...
class Query5(APIView):
    ...
    def get(self, request):
        ...
        crew_commander = Crew.objects.values('crew_commander').count()
        second_pilot = Crew.objects.values('second_pilot').count()
        navigator = Crew.objects.values('navigator').count()
