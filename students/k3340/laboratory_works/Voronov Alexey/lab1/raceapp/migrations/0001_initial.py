# Generated by Django 3.0.5 on 2020-06-15 19:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Механик'), (2, 'Пилот')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='raceapp.Race', verbose_name='Гонка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Вопрос о сотрудничестве'), (2, 'Вопрос о гонках'), (3, 'Иное')], default=3, verbose_name='Тип комментария')),
                ('text', models.CharField(max_length=100, verbose_name='Текст')),
                ('result', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='raceapp.Result', verbose_name='Результат')),
