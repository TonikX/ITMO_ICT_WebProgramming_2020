# Generated by Django 3.1.2 on 2020-10-29 14:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_data', models.CharField(blank=True, max_length=10, null=True, verbose_name='Паспортные данные')),
                ('home_address', models.TextField(blank=True, null=True, verbose_name='Домашний адрес')),
                ('nationality', models.CharField(blank=True, max_length=40, null=True, verbose_name='Национальность')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_num', models.CharField(max_length=17, verbose_name='Гос. номер')),
            ],
        ),
        migrations.CreateModel(
            name='Ownership',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=7)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
