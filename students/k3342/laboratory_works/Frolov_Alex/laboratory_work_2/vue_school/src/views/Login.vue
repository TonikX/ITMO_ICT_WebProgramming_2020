    ...
    <mu-container>
        <mu-row align="center">
            <mu-col>
                ...
                <br/>
                <mu-button color="darkgray" style: text-color="black" @click="setLogin">Войти</mu-button>
            </mu-col>
        </mu-row>
        <mu-row align="center">
            <mu-col>
            <br>
                <p> Нет логина и пароля? Тогда Вам необходимо <a href="/registration">зарегистрироваться</a></p>
            </mu-col>
        </mu-row>
    </mu-container>
</template>
