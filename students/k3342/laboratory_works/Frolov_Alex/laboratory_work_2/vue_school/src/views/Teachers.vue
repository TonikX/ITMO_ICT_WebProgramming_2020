<template>
    <mu-container>
        ...
        <mu-row align="left">
            <mu-col span="10">
                <ol class="ball" v-for="teacher in listTeacher" :key="teacher.id">
                    <li><a href="#" @click="goTo(teacher.id)">{{teacher.surname}} {{teacher.name}}
        ...
        <mu-row align="center">
            <mu-col span="10" align-self="center">
                <mu-button color="darkgray" style: text-color="black" @click="showModal">Добавить учителя</mu-button>
                <modal
