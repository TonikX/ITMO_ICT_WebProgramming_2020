...
urlpatterns = [
    ...
    path('author/<str:a_slug>/delete/', AuthorDelete.as_view(), name='author_delete_url'),
    ...
    path('publishers/<str:p_slug>/', PublisherUpdate.as_view(), name='publisher_update_url'),
    path('publishers/<str:p_slug>/', PublisherDelete.as_view(), name='publisher_delete_url'),
