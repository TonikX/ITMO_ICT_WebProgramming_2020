# Generated by Django 3.0.4 on 2020-05-07 12:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('A', 'Class A'), ('B', 'Class B'), ('C', 'Class C'), ('D', 'Class D'), ('M', 'Class M'), ('ACDL', 'Class A CDL'), ('BCDL', 'Class B CDL'), ('CCDL', 'Class C CDL'), ('MCDL', 'Class M CDL')], max_length=4)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
