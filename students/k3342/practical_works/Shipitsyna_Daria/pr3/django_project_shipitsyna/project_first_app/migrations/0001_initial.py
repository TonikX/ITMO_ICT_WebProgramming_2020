# Generated by Django 3.0.4 on 2020-05-28 12:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(blank=True, default='1999-01-01', null=True)),
                ('passport', models.IntegerField(default=1234567890, null=True)),
                ('address', models.CharField(blank=True, default='russia', max_length=150, null=True)),
                ('nationality', models.CharField(blank=True, default='secret', max_length=30, null=True)),
