  ...
  <main>
    <div class="d-flex flex-column">
      ...
      <div class="content container mt-5">
        ...
        <flight v-for="flight in flights" :key="flight.id" :arrival="flight.arrival" :departure="flight.departure" :price="flight.price" :tickets="flight.tickets" :transit="flight.is_transit" :distance="flight.distance"></flight>
      </div>
    </div>
  </main>
</template>
