...
export default {
  ...
  methods: {
  	...
  	filterEnrollee () {
  	  ...
  	  let url = `http://${window.location.hostname}:8000/api/applications/?specialization=${specialization}&school_class=${schoolClass}&education_form=${educationForm}&state=${state}&date=${this.date}`
